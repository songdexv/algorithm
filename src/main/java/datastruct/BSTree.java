...
/**
 * 二叉查找树
 * Created by songdexv on 2018/4/2.
 */
public class BSTree<T extends Comparable<T>> {
     ...
     * @param p
     */
    private void preOrderTraverse(BSTNode<T> p) {
        if (p != null) {
     ...
     * @param p
     */
    private void inOrderTraverse(BSTNode<T> p) {
        if (p != null) {
            Stack<BSTNode<T>> stack = new Stack<BSTNode<T>>();
            BSTNode<T> node = p;
            while (node != null || stack.size() > 0) {
     ...
     * @param p
     */
    private void postOrderTraverse(BSTNode<T> p) {
        if (p != null) {
            Stack<BSTNode<T>> stack = new Stack<BSTNode<T>>();
